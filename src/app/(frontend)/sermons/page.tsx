...
import { getSermons, getPageGlobal } from "@/lib/payload";
...
export default async function SermonsPage() {
  ...
  const pageContent = await getPageGlobal('sermons-page') as Record<string, any> | null;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="inline-block px-4 py-1.5 bg-church-green-light text-church-green text-sm font-semibold rounded-full mb-4">
              {pageContent?.badge || "Messages"}
            </div>
            <h1 className="text-4xl md:text-5xl font-bold text-church-dark mb-4">{pageContent?.heroHeading || "Sermons"}</h1>
            <p className="text-church-gray max-w-2xl mx-auto">
              {pageContent?.heroSubheading || "Watch our latest messages or browse through our sermon archive."}
            </p>
          </div>
          ...
          {hasSermons ? (
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <h2 className="text-lg font-bold text-church-dark mb-2 line-clamp-2">
                        {sermon.title}
                      </h2>
            ...
            <div className="text-center py-20 bg-church-cream rounded-2xl">
              ...
              <h2 className="text-2xl font-bold text-church-dark mb-4">{pageContent?.emptyHeading || "Sermons Coming Soon"}</h2>
              <p className="text-church-gray mb-8 max-w-md mx-auto">
                {pageContent?.emptyBody || "Add sermons through the Sanity CMS to display them here. In the meantime, catch our live stream!"}
              </p>
              <a
