...
import { contactPageQuery, siteSettingsQuery } from "@/sanity/queries/index";
import type { ContactPage, SiteSettings } from "@/sanity/queries/types";
...
export default async function ContactPageRoute() {
  const contactPage = await safeFetch<ContactPage>(contactPageQuery);
  const settings = await safeFetch<SiteSettings>(siteSettingsQuery);

  const heading = contactPage?.heroHeading || "Contact Us";
  const subheading =
